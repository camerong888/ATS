...
class PandasDataWithPredictions(bt.feeds.PandasData):
    ...
    params = (
        ...
        ("CDL_3OUTSIDE", -1),
        ("CDL_3STARSINSOUTH", -1),
        ("CDL_3WHITESOLDIERS", -1),
        ("CDL_ABANDONEDBABY", -1),
        ("CDL_ADVANCEBLOCK", -1),
        ("CDL_BELTHOLD", -1),
        ("CDL_BREAKAWAY", -1),
        ("CDL_CLOSINGMARUBOZU", -1),
        ("CDL_CONCEALBABYSWALL", -1),
        ("CDL_COUNTERATTACK", -1),
        ("CDL_DARKCLOUDCOVER", -1),
        ("CDL_DOJI_10_0.1", -1),
        ("CDL_DOJISTAR", -1),
        ("CDL_DRAGONFLYDOJI", -1),
        ("CDL_ENGULFING", -1),
        ("CDL_EVENINGDOJISTAR", -1),
        ("CDL_EVENINGSTAR", -1),
        ("CDL_GAPSIDESIDEWHITE", -1),
        ("CDL_GRAVESTONEDOJI", -1),
        ("CDL_HAMMER", -1),
        ("CDL_HANGINGMAN", -1),
        ("CDL_HARAMI", -1),
        ("CDL_HARAMICROSS", -1),
        ...
        ("CDL_HIKKAKEMOD", -1),
        ("CDL_HOMINGPIGEON", -1),
        ("CDL_IDENTICAL3CROWS", -1),
        ("CDL_INNECK", -1),
        ("CDL_INSIDE", -1),
        ("CDL_INVERTEDHAMMER", -1),
        ("CDL_KICKING", -1),
        ("CDL_KICKINGBYLENGTH", -1),
        ("CDL_LADDERBOTTOM", -1),
        ("CDL_LONGLEGGEDDOJI", -1),
        ("CDL_LONGLINE", -1),
        ("CDL_MARUBOZU", -1),
        ("CDL_MATCHINGLOW", -1),
        ("CDL_MATHOLD", -1),
        ("CDL_MORNINGDOJISTAR", -1),
        ("CDL_MORNINGSTAR", -1),
        ("CDL_ONNECK", -1),
        ("CDL_PIERCING", -1),
        ("CDL_RICKSHAWMAN", -1),
        ("CDL_RISEFALL3METHODS", -1),
        ("CDL_SEPARATINGLINES", -1),
        ("CDL_SHOOTINGSTAR", -1),
        ("CDL_SHORTLINE", -1),
        ("CDL_SPINNINGTOP", -1),
        ("CDL_STALLEDPATTERN", -1),
        ("CDL_STICKSANDWICH", -1),
        ("CDL_TAKURI", -1),
        ("CDL_TASUKIGAP", -1),
        ("CDL_THRUSTING", -1),
        ("CDL_TRISTAR", -1),
        ("CDL_UNIQUE3RIVER", -1),
        ("CDL_UPSIDEGAP2CROWS", -1),
        ("CDL_XSIDEGAP3METHODS", -1),
    )
